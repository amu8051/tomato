...
import { dineOutRestaurants } from './common/dineOutRestaurants';
...
const DineOut = () => {
  return (
    <div>
      <Collection list={dineOutCollection} />
      <div className="max-width">
        <Filters filters={diningFilters} />
      </div>
      <ExploreSection
        restaurants={dineOutRestaurants}
        exploreSectionName="Dine-Out Restaurants in Pune"
      />
    </div>
  );
};
